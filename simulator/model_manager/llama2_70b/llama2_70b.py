...
from simulator.model_manager.llama2_70b.rtx5090.llama2_70b_rtx5090 import LLaMa70BonRTX5090
    ...
    def __init__(self, num_machines_dict: Dict[str, int]):
        ...
        for iteration in range(10):
            ...
            if "RTX5090" in num_machines_dict:
                rtx5090 = LLaMa70BonRTX5090(num_machines_dict=num_machines_dict,
                                            typical_layers_dict=typical_layers_dict,
                                            normalized_perf_dict=normalized_perf_dict)
        ...
        if "A100" in num_machines_dict:
            ...
            self.a100 = None
        if "RTX5090" in num_machines_dict:
            self.rtx5090 = LLaMa70BonRTX5090(num_machines_dict=num_machines_dict,
                                             typical_layers_dict=typical_layers_dict,
                                             normalized_perf_dict=normalized_perf_dict)
        else:
            self.rtx5090 = None
